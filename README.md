...
###### Importing Data from Different Sources to Excel

### Searching and Manipulating Data in Excel 2016
If you're a business analyst or even a regular spreadsheet user, rather than creating a spreadsheet from scratch, you'll mostly encounter them already filled with plenty of data. It then becomes imperative that you understand how to search and manipulate data within these. And helping you do that is exactly what this course - the 2nd in the Microsoft Excel series at Pluralsight - is targeted towards. In the first two modules, we’ll mostly deal with how to work and manipulate an excel workbook/worksheet that already contains the required data. Here we’ll deal with things like data validation and conducting what-if analysis. The second module deals with navigating an excel worksheet/workbook. Here we’ll learn methods that help us search the required data and navigate to it. We’ll also talk a bit about inserting and removing hyperlinks. In the last module, we’ll be dealing with how to insert data into excel cells. This will include learning to paste data with special paste options, filling cells with autofill and inserting and deleting cells themselves. When you're finished with this course, you'll have the skills and the practice required to search and manipulate spreadsheet data with Microsoft Excel.
###### Working with Data in Excel
###### Navigating Worksheets and Workbooks
###### Entering and Manipulating Data in Cells
...
The power and capabilities of Microsoft Excel stem primarily from the things it can do with functions and formulas. As such, learning how to implement, debug, and monitor them becomes an invaluable skill. This course, Calculating Cell Values with Formulas, aims to help you through that maze. The first three modules deal with the implementation of functions and formulas to deal with things like performing calculations with aggregate functions, performing logical and statistical operations, referencing and serializing dates and times, and looking up data in Excel. In the fourth and fifth modules, you’ll focus on troubleshooting and auditing these formulas. You'll explore techniques like tracing precedents and dependents, monitoring cells and formulas with Watch Window, etc. When you're finished with this course, you'll know how to implement and troubleshoot functions and formulas in Excel.
###### Implementing Operations and Performing Calculations with Functions and Formulas
###### Referencing and Serializing Date and Time in Excel
###### Cell References and Data Lookup in Excel
###### Monitoring, Validating, and Debugging Cells and Formulas in Excel
...
###### Grouping Data and Outlining Your Data
###### Inserting Totals and Subtotals
###### Applying Conditional Formatting
###### Inserting Sparklines
###### Exploring Other Excel Capabilities
...
###### Tables: What Are They and Why Use Them?
...
###### Choosing, Creating, and Changing Chart Types
###### Enhancing the Column Chart with Data Series
###### Extracting Insights from the Line Chart
###### Exploring Specialized Visuals for Categorical Data
###### Exploring Specialized Visuals for Continuous Data
...
###### Modifying PivotTable Formatting
###### Choosing How PivotTable Values Are Presented and Displayed
###### Creating New PivotTable Values
###### Adding Grouping, Slicing, and Filtering Interactivity
###### Exploring Other Excel Capabilities
...
###### Printing Exactly What You Want
###### Exporting to Different Formats
###### Securing Your Workbook
###### Identifying Hidden Information or Defects
